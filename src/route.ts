...
import { contratoRegraSlaRouter } from './routes/contrato.regra.sla.routes';
...
router.use('/api/v1/sla', slaRouter);
...
router.use('/api/v1/contrato-regra-sla', contratoRegraSlaRouter);
